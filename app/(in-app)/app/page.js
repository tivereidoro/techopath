    ...
    <div className="min-h-screen container mx-auto px-4 py-8 md:py-12">
      <header className="text-center mb-10 md:mb-12">
        ...
        <p className="text-lg text-slate-300">
          Discover personalized tech career suggestions powered by AI.
        </p>
      </header>

      <div className="max-w-2xl mx-auto bg-slate-800 p-6 md:p-8 rounded-xl shadow-2xl border border-slate-700">
